...
#define MyAppName "Cassolette"
#define MyAppVersion "1.0"
#define MyAppPublisher "Fougue Ltd"
#define MyAppURL "http://www.fougue.pro"
#define MyAppExeName "cassolette.exe"
...
AllowNoIcons=yes
OutputBaseFilename=setup_cassolette_v{#MyAppVersion}_win_{#TargetArch}
Compression=lzma
...
Source: "run_cassolette.bat"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\run_cassolette.bat"; WorkingDir: "{app}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\run_cassolette.bat"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\run_cassolette.bat"; Tasks: quicklaunchicon
